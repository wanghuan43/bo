...
class   Orders extends BoModel
{
    ...
    {
        $this->searchable['o_tax']['options'] = getTaxList();
        $this->searchable['o_tax']['options'][0] = '--请选择--';
        return parent::getSearchable(); // TODO: Change the autogenerated stub
    }

    public function getList($search, $limit = false, $aType = false, $trashed = 2)
    {
        $this->alias('o');
        $this->field("o.*");
    ...
    public function save($data = [], $where = [], $sequence = null)
    {
        ...
        $clm->setOrderCirculation($this->o_id, $cList, "orders");
    ...
    public function deleteOrders($id)
    {
        ...
        if (!empty($order->o_foreign)) {
            $fo = $this->find($order->o_foreign);
            $fo->o_trashed = 1;
            $fo->save($fo->getData(), ['o_id' => $fo->o_id]);
        }
        $order->o_trashed = 1;
        return $order->save($order->getData(), ['o_id' => $id]); // TODO: Change the autogenerated stub
    }
